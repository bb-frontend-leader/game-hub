...
export class Card extends Phaser.GameObjects.Container {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number, cardData: AnswerCardData) {
    super(scene, x, y);
    ...
    if (cardData.iconKey) {
      ...
      const s = Math.min(CARD_DIM.iconSize / this.icon.width, CARD_DIM.iconSize / this.icon.height);
