...
export class MainMenu extends Scene {
  ...
  private renderIntroUI(theme = this.getTheme()) {
    ...
    announce(
      'El templo del conocimiento, un juego de preguntas y respuestas. Presiona "Iniciar" para jugar.',
    );
