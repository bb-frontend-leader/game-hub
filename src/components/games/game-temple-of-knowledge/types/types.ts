...
export const WORLD_THEMES: ThemeType[] = [
  {
    ...
    assets: {
      images: [{ name: "bg", path: "images/background/game_background_3.png" }],
      cardImages: ["images/poisons/card_3.png"],
    },
  },
  {
    id: 2,
    ...
    assets: {
      images: [{ name: "bg", path: "images/background/game_background_1.png" }],
      cardImages: ["images/poisons/card_1.png"],
    },
  },
  {
    id: 3,
    ...
    assets: {
      images: [{ name: "bg", path: "images/background/game_background_2.png" }],
      cardImages: ["images/poisons/card_2.png"],
    },
  },
];
