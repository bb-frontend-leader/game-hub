...
export class EndGame extends Phaser.Scene {
  ...
  create() {
    ...
    const resultClass = this.won
      ? "game-whack_endgame-title--win"
      : "game-whack_endgame-title--lose";
    ...
    const restartButton = guiContainer.querySelector(
      ".game-whack_endgame-button",
