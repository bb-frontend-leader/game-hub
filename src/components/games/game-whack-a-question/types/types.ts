...
export const DEFAULT_THEME: ThemeType = {
  ...
  assets: {
    images: [
      ...
      {
        name: "background-1",
        path: "assets/game-whack-a-question/images/background-initial/1.png",
      },
      ...
      {
        name: "background_sky",
        path: "assets/game-whack-a-question/images/backgrounds/background_sky.png",
      },
      {
        name: "clouds_medium",
    ...
    tileMap: [
      {
        name: "mapa_bosque",
        path: "assets/game-whack-a-question/tiles/normalMapWhackAQuestion.json",
      },
    ],
    ambiencesSounds: [
      {
        name: "bg_music-normal",
        path: "assets/game-whack-a-question/music/ambience/normal-game.mp3",
      },
    ],
  },
};
