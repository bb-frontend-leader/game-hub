import { DEFAULT_THEME, ThemeType } from "../types/types";

// Tema único del juego (Pradera). Se mantiene el ThemeManager como
// singleton de solo lectura para no romper a los consumidores
// (PreloadScene, MenuScene, helpers de assets).
class ThemeManager {
  private currentTheme: ThemeType = DEFAULT_THEME;

  // Obtener el tema actual (siempre Pradera)
  ...
  // Resetear al tema por defecto (noop, solo reaplica)
  reset(): void {
