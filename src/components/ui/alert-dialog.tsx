...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("font-pixel text-base font-bold uppercase leading-relaxed text-gold", className)}
    {...props}
  />
));
...
// La acción confirma; si es destructiva se pinta de rojo con variant="destructive".
